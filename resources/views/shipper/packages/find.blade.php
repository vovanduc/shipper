...
<div class="col-md-9">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            {{ Form::open(array('route' => array('shipper.packages.find'), 'method' => 'get')) }}
            <ul class="list-group">
            ...
            @if($result)
                ...
                <li class="list-group-item">
                    <div class="row">
                        <div class="col-xs-12" >
                            {{$item->address}}<br/>
                            <a href="{{URL::route('shipper.packages.show', $item->uuid)}}" target="_blank">
                                Xem chi tiết
                            </a>
                            {{ Form::open(array('route' => array('shipper.packages.find'), 'method' => 'get')) }}
                                ...
                                <span class="pull-right">
                                    <button class="btn btn-primary" type="submit" href="{{URL::route('shipper.packages.show', $item->uuid)}}" target="_blank">
                                    Chọn kiện hàng
                                    </button>
                                </span>
                            {{ Form::close() }}
